...
<div class="resrlayout">
	...
	<div>
		<div class="resinfobox">
				<div class="pad3"><img src="images/<%=lvo.getLodimg1()%>" width="150px" height="150px"></div>
				<div class="pad3"><%=lvo.getLodname() %></div>
				<div class="col1">날짜 : <%=today %> ~ <%=tomorrow %></div>
				<div class="col1">게스트 : <%=people%>명</div>
				<div class="col2"><h3>요금 세부 정보</h3></div>
				<div class="pad2"><%=lvo.getLodprice()%>x<%=loddate %>박</div>
				<div class="pad1"><%=lvo.getLodprice()*Integer.parseInt(loddate) %></div>
				<div class="pad2">수수료</div>
				<div class="pad1"><%=1000*(people) %></div>
				<div class="pad2">총 햡계(KRW)</div>
				<div class="pad1"> <%=lodresprice %></div>
